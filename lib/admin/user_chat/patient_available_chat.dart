...
class PatientAvailableChat extends StatefulWidget {
  @override
  _PatientAvailableChatState createState() => _PatientAvailableChatState();
}

class _PatientAvailableChatState extends State<PatientAvailableChat> {
